    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto min-h-[calc(100vh-57px-97px)] w-full flex-1">
        ...
        <p className="my-8 px-4 text-justify text-lg font-medium">
          ...
          harum dolore molestiae nihil ipsa est eveniet sed? Totam sapiente
          itaque minima reprehenderit placeat incidunt quibusdam nam similique
          ...
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="text-base">
                ...
                ex, doloremque dicta aliquam repellat obcaecati maxime eaque
                iste nisi, modi error.
              </AccordionContent>
            </AccordionItem>
